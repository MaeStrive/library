 ...
 * @Description:
 */
@WebServlet(name = "RecoverCardServlet", urlPatterns = "/RecoverCardServlet")
public class RecoverCardServlet extends HttpServlet {
    ...
    private void processRequest(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        cardService.recoverCard(Long.valueOf(id));
