 ...
 * @Description:
 */
@WebServlet(name = "ListCardWasteServletLiked", urlPatterns = "/ListCardWasteServletLiked")
public class ListCardWasteServletLiked extends HttpServlet {
    ...
    private void processRequest(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<CardVO> cardVOS = cardService.queryCardsLikedByWaste(user.getId(), likedName);
        if (cardVOS.isEmpty()) {
